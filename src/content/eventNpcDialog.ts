...
export const WALSH_AFTER_FIRE_DIALOG =
    "Inspector Walsh: The dining-room fire wasn't misfortune — someone tried to silence you. Stay sharp, and report anything further.";

export const WALSH_AFTER_ATTIC_DIALOG =
    "Inspector Walsh: Assaulted again after the attic chest? This killer is getting bold. Keep gathering proof — we'll move when you have it.";
...
export const REED_AFTER_FIRE_DIALOG =
    "Constable Reed: Heard about the dining room. Glad you're upright, Detective. Nobody leaves — and that includes whoever started that fire.";
...
export const BUTLER_AFTER_FIRE_DIALOG =
    "Mr. Thompson: The dining room… I showed the master in there myself only hours before. Smoke and ash where the silver should be. Appalling.";
...
export const STABLE_BOY_AFTER_FIRE_DIALOG =
    "Stable Boy: Heard there was a fire in the dining room. Horses went mad at the smell of smoke. Glad you got out.";
